...
const SearchManga = ({
  ...
  const years = Array.from(
    { length: (2023 - 1940) / 1 + 1 },
    (value, index) => 1940 + index * 1
  );
  ...
  const resetSelect = (event) => {
    ...
    if (genreFilter.length == 0 || typeFilter == null || statusFilter == null) {
    ...
    <div className='search-container'>
      <div className='search-subcontainer'>
        <form onSubmit={resetSelect} className='search-form'>
          <input name='text' type='text' placeholder='manga'></input>
          <select
